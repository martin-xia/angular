...
angular.module('miniapp')
	...
	}]).directive('dirPaginationControls', ['paginationService', 'paginationTemplate', 'i18n', function(paginationService, paginationTemplate,i18n) {
        ...
        return {
            ...
            link: function dirPaginationControlsLinkFn(scope, element, attrs) {
                ...
                scope.goToPage = function () {
    				var page = angular.element('input.form-control-pagination').val();
    				page = page > scope.pagination.last ? scope.pagination.last : page;
    				if (isValidPageNumber(page)) {
                        paginationService.setCurrentPage(paginationId, page);
                ...
                scope.setCurrent = function(num) {
                    ...
                    }else if(numberRegex.test(num)&&num>scope.pagination.last){
                    	paginationService.setCurrentPage(paginationId, scope.pagination.last);
	...
	}).provider('paginationTemplate', function() {
